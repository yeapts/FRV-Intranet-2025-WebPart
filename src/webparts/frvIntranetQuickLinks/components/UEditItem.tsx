...
export const editItem = async (props:Props, itemId:number, title:string, url:string, webpart:string, page:string, section:string, setEditDialogIsOpen:React.Dispatch<React.SetStateAction<boolean>>, setState: React.Dispatch<React.SetStateAction<QuicklinkState>>): Promise<void> => {
  try {
